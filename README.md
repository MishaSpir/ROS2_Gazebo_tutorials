...
## Добавил алгоритм сопостовления
![alt text](image-1.png)

## Настроил параметры (и скорость) для отрисовки карты.
Есть проблема, в каких-то моментах odom может крутануться на 360 градусов и вернутся в туже точку, пока не знаю в чем дело.
...
![alt text](<Pasted image 20260519230742.png>)